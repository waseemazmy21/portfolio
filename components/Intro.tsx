  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          className='group btn bg-white px-7 py-3 flex items-center gap-2 rounded-full borderBlack'
          href='/cv.pdf'
          download
        >
          Download CV{' '}
        ...
        <a
          className='btn bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full  borderBlack'
        ...
        <a
          className='btn bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full hover:text-gray-950 borderBlack'
